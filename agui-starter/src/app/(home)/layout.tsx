...
export default function HomeLayout({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen bg-[color-mix(in_srgb,_var(--agui-surface)_96%,_white_4%)] text-foreground flex flex-col">
      <header className="relative z-[60] h-14 text-[var(--agui-on-surface)] flex items-center justify-between px-4 md:px-6 bg-transparent border-0 shadow-none">
        ...
        <div className="flex items-center gap-2">
          <ThemeToggle className="h-9 w-9 p-0 rounded-2xl" variant="ghost" />
