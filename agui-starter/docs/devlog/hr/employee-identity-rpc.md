...
- Update: RPC accepts an identifier map JSON argument and resolves existing identities before creating rows; employee creation rejects duplicate active identities per house.
