...
- **Emergency contacts:** Keep emergency contact details separate from identity identifiers (do not overload shared phone/email). Add a dedicated model/fields in a follow-up; do not conflate with identity linkage.
