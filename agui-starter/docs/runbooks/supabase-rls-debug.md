...
- Identity RPCs: `hr_find_or_create_entity_for_employee` must be executable by `authenticated`; permission errors here will surface as “unable to link identity” in HR flows.
